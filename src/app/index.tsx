...
import { type SessionNotice, clearSessionNotice, useSessionNotice } from '@/utils/session-notice';
...
export default function LoginScreen() {
    ...
    const displayedBanner: LoginBanner | null =
        banner ?? (sessionNotice != null ? SESSION_NOTICE_BANNERS[sessionNotice] : null);
