...
| v1.0-r5 | 2026-09-16 | ① §2.1 **N3 已完全閉合**（`9.5 + 1.0 + 6.25 + 2.5 = 19.25`，未歸屬項 = W-04 0.5 + W-32 1.5 + W-33 0.5）；② §2.1 三 bucket 的 🟡 列由 `0.75 / 2.0` 改為 **`1.0`**（＝ W-26）；③ 全 W-ID 總數 23 → **30**；④ 契約漂移新增 **D-4**（`EventStatus` 值域）| VERIFY R2 findings N-1 / N-3 |
